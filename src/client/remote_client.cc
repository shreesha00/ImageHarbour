...
int main(int argc, const char* argv[]) {
    ...
    // std::string pull_cmd = "docker pull pytorch/pytorch:latest";
    // std::string pull_cmd = "docker pull postgres:15";
    // std::string pull_cmd = "docker pull debian";
    std::string pull_cmd = "docker pull alpine";
